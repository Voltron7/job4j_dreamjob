...
public class MemoryVacancyRepository implements VacancyRepository {
    ...
    private MemoryVacancyRepository() {
        ...
        save(new Vacancy(0, "Middle Java Developer", "description4", LocalDateTime.now(), true, 1, 0));
        save(new Vacancy(0, "Middle+ Java Developer", "description5", LocalDateTime.now(), false, 2, 0));
