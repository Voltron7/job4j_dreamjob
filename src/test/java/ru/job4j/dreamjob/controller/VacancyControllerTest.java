...
class VacancyControllerTest {
    ...
    @Test
    public void whenPostVacancyWithNotExistingFileThenSameDataAndRedirectToErrorPage() {
    ...
    @Test
    public void whenRequestVacancyByIdThenRedirectToVacanciesOnePage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenRequestNotExistingVacancyByIdThenRedirectToErrorPage() {
    ...
    @Test
    public void whenPostVacancyWithFileAndUpdateThenSameDataAndRedirectToVacanciesPage() throws Exception {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenDeleteNotExistingVacancyByIdThenRedirectToErrorPage() {
        int vacancyId = 1;
